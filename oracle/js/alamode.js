...
var alamode = {
  ...
  addContainerElement: function(el, clear) {
    ...
    if (el == "body") {
      $("<div id='" + id + "'></div>").addClass(id).addClass("mode-graphic-container").addClass("col-md-8").appendTo(".neighbours-container");
    } else if ($(el).length === 0) {
  ...
  leafletMap: function(o) {
    ...
    var latColumn = o["lat_column"],
        ...
        width = o["width"] || 500,
        htmlElement= o["html_element"] || "body",
        centerLat = o["center_lat"] || 52.476146,
        centerLng = o["center_lng"] || 13.424131,
        zoom = o["starting_zoom"] || 11,
    ...
    d3.select(uniqContainerClass)
      // .attr("class","col-md-6 mode-graphic-container")
